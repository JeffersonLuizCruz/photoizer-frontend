import { LayoutDashboard, Settings, Users, Calendar, DollarSign, ListTodo, Percent, Package, ShoppingCart, Ticket, Image, Bell } from 'lucide-react'
...
const navItems = [
  ...
  { to: ROUTES.NOTIFICACOES, label: 'Notificações', icon: Bell },

...
import { Download, CheckCircle2, Circle, Trash2, Images, ChevronUp, ChevronDown } from 'lucide-react'
          ...
          return (
            ...
            >
              <div className="aspect-square w-full overflow-hidden bg-muted">
                <AuthImage
                  src={showingEdited ? (foto.editedPreviewUrl ?? foto.rawPreviewUrl) : foto.rawPreviewUrl}
